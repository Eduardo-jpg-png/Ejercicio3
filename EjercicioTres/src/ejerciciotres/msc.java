...
public class msc extends javax.swing.JFrame {
    ...
    String nombre, sexo;
    Double edad, peso, altura, imc;
    nombre=nom.getText();
    nom.setText(nombre);
    sexo=sex.getText();
    sex.setText(sexo);
    edad=Double.parseDouble(ed.getText());
    ed.setText(String.valueOf(edad));
    peso=Double.parseDouble(pes.getText());
    pes.setText(String.valueOf(peso));
    altura=Double.parseDouble(alt.getText());
    alt.setText(String.valueOf(altura));
    imc=peso/(Math.pow(altura,2));
    tot.setText(String.valueOf(imc));
      if(imc<18.5){
        id.setText("Bajo de peso");
        }else if(imc>=18.5 && imc<24.9){
        id.setText("Peso saludable");
        }else if(imc>=25 && imc <29.9){
        id.setText("Sobrepeso");
        }else if(imc>30){
        id.setText("Obesidad");
        }
